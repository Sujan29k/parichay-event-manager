      ...
      <div className="pt-24 pb-12 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Have a question about our events? Need support? Our team is ready to assist you with anything you need.
          </p>
        </div>
      </div>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-8 border border-gray-100 hover:border-red-200">
                ...
                <p className="text-green-600 font-semibold">
                  Kathmandu, Nepal<br />
                  <span className="text-sm text-gray-500 font-normal">Thamel, Kathmandu 44600</span>
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl shadow-lg p-8 border border-gray-700">
                ...
                <p className="text-gray-300 mb-6 text-sm">Stay connected on social media</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <label htmlFor="privacy" className="text-sm text-gray-600">
                      I agree to the <a href="#" className="text-red-600 hover:text-red-700 font-medium">privacy policy</a> and consent to Parichaya Events collecting my details.
                    </label>
                  </div>
          ...
          <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-3xl p-8 md:p-12 border border-red-100">
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
              <div className="bg-white rounded-xl p-6 shadow-md">
                ...
                <p className="text-gray-600 text-sm ml-7">Browse events, select your preferred one, choose your tickets, and complete the checkout process.</p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-md">
                <h3 className="font-bold text-gray-900 mb-2 flex items-start gap-2">
                  <svg className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <p className="text-gray-600 text-sm ml-7">We accept all major credit cards, debit cards, and digital payment methods like eSewa and Khalti.</p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-md">
                <h3 className="font-bold text-gray-900 mb-2 flex items-start gap-2">
                  <svg className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <p className="text-gray-600 text-sm ml-7">Refund policies vary by event. Check the specific event's terms or contact support for assistance.</p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-md">
                <h3 className="font-bold text-gray-900 mb-2 flex items-start gap-2">
                  <svg className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <p className="text-gray-600 text-sm ml-7">Tickets are sent to your email immediately after purchase. You can also download them from your account.</p>
              </div>
            </div>
          </div>
        </div>
